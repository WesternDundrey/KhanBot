...
def generate_random_name(existing_names_list):
    ...
    while True:
        ...
        second_category = random.choice(
            [category for category in categories if category != first_category]
        )
        ...
        if name not in existing_names:
            ...
            existing_names_list.append(
                name
            )  # Update the list to keep track of used names
            return name
